...
export const sqlStatementCreateImagesTable =
  "CREATE TABLE IF NOT EXISTS images (imageId TEXT UNIQUE NOT NULL PRIMARY KEY, referenceId TEXT NOT NULL, referenceType TEXT NOT NULL, imageLocation TEXT NOT NULL)";
